...
return [
    ...
    'completed_jobs' => [
        ...
        'breadcrumb_runs' => 'По минутам',
        'run_heading' => 'Выполненный запуск',
        'run_details' => 'Детали запуска',
        'run_details_subtitle' => 'Идентификатор, время и очередь',
        'payload_subtitle' => 'Пейлоад, который задание имело при постановке в очередь',
