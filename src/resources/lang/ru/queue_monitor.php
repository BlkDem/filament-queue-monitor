...
return [
    ...
    'completed_jobs' => [
        ...
        'minute' => 'Минута',
        'detail_subtitle' => 'Активность этого класса заданий по минутам',
        'detail_empty' => 'За выбранный период этот класс заданий не выполнялся.',
        'detail_search_placeholder' => 'Поиск очередей...',
        'back' => 'Назад к выполненным заданиям',
        'breadcrumb_class' => 'По классу задания',
        'runs_heading' => 'Запуски :job',
        'runs_subtitle' => 'Отдельные выполнения в :minute',
        'runs_table_missing' => 'Выполните миграции монитора очередей, чтобы начать записывать отдельные запуски.',
        'runs_empty' => 'За эту минуту отдельные запуски этого класса не зафиксированы.',
        'runs_search_placeholder' => 'Поиск идентификаторов...',
        'back_to_class' => 'Назад к классу задания',
        'uuid' => 'ID задания',
